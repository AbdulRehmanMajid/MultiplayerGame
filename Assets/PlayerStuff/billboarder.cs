...
public class billboarder : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
        Vector3 pos = camera.GetComponent<Camera>().WorldToScreenPoint(target.transform.position);
            damage_Text.transform.position = new Vector3(pos.x,pos.y,0f);
        }
    ...
    void Update()
    {
        ...
        damage_Text.transform.position += new Vector3(random_X,moveupSpeed,0) * Time.deltaTime;
        if(disappertimer > disappear_max * .5f)
        {
